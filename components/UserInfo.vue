<template>
    <v-card class="mx-auto mt-8" elevation='0'>
        ...
        <v-card-text class="text--primary">
            <v-img :src="user.headerImg?$store.state.configURL+user.headerImg:require('/static/head.webp')" :alt="user.nickName || '小诸葛'"  class="mb-3" style="border-radius: 5px; width: 80px;" />
