    ...
    <div>
        <div class="rounded-lg mt-12 pt-3">
            ...
            <div class="d-flex mb-4" v-else>
                <img :src="headerImg?$store.state.configURL+headerImg:require('@/static/head.webp')" alt="头像" max-width="50" height="50" class="mr-1  rounded-lg elevation-3" />
            ...
            <v-card v-for="(item, index) in commentInfo" :key="index" class="my-4 pa-3 rounded-lg" elevation="0">
                <div class="d-flex">
